    ...
    <section className='bg-hero bg-no-repeat relative xl:bg-cover xl:h-[1098px] py-40 pb-32 xl:py-0' id="home">
      <div className="container mx-auto">
        ...
        <div className="flex items-center xl:h-[960px]">
          {/* text */}
          <div className="w-full xl:max-w-[460px] text-center xl:text-start">
            <motion.h1
          ...
          className="hidden xl:flex xl:absolute xl:top-[200px] xl:right-0">
            <Image
            src='/hero/plate.png' width={756} height={682} alt="plate"
            />
          </motion.div>
        </div>
      </div>
      ...
      className="hidden xl:flex xl:relative xl:-top-36">
        <Image
        src='/hero/coffee.png' width={386} height={404} alt="coffee"
        />
      </motion.div>
    </section>
  )
