...
const About = () => {
  return (
    <section id="about" className="grid grid-cols-1 xl:grid-cols-2 gap-x-[74px] p-8 md:p-12 xl:p-0 items-center">
        {/* text */}
        <motion.div 
        ...
        >
            <Image
            src='/about/img.png' width={705} height={771} alt="about_image"
